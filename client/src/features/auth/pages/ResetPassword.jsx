    ...
    <div className="min-h-screen bg-white text-gray-800 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-medium">Create your new password</p>
        </div>

        <Card className="border-gray-200">
          <h3 className="text-2xl font-bold mb-2 text-gray-900 text-center">Reset Password</h3>
          ...
          {success ? (
            <div className="text-center">
              ...
              <Link
                to="/login"
                className="inline-block mt-2 px-6 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-all duration-200"
              >
                Go to Login
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="confirm-new-password">
